...
project = meta["name"]
copyright = '2013-2018 Spotify AB and contributors'
...
latex_documents = [
  ('index', 'dh-virtualenv.tex', 'dh-virtualenv Documentation',
   'Spotify AB', 'manual'),
]
...
man_pages = [
    ('index', 'dh-virtualenv', 'dh-virtualenv Documentation',
     ['Spotify AB'], 1)
]
